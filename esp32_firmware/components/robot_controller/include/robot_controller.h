...
typedef enum
{
    ...
    ROBOT_STATE_INITIALIZING,  ///< In the process of powering on
    ...
    ROBOT_STATE_ERROR,         ///< An error has occurred (e.g., repeated CAN timeouts)
    ROBOT_STATE_SHUTTING_DOWN  ///< In the process of turning off
} robot_state_t;
